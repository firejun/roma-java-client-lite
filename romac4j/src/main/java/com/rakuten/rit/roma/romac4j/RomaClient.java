...
public class RomaClient {
    ...
    protected Receiver sendCmd(Receiver rcv,String cmd, String key, String opt, byte[] value){
	boolean retry;
	do{
	    retry = false;
	...
	Receiver rcv = sendCmd(new StringReceiver(), "set", key, value, "0 0 " + value.length);
